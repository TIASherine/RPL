...
export default function InputSampah() {
  ...
  return (
    <div>
      <PageHeader
        title="InputSampah"
        breadcrumb="InputSampah"
        children="Add InputSampah"
        onClick={() => setShowContent((prev) => !prev)}
      >
        {showContent ? "Hide InputSampah" : "Add InputSampah"}
      </PageHeader>

      <h1 className="m-4 text-green-600"> Ini adalah halaman Input Sampah </h1>
