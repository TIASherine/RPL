...
export default function Dashboard() {
  return (
    <div className="flex-1">
      <PageHeader breadcrumb="Beranda"> </PageHeader>
        ...
        <div className="grid grid-cols-3 gap-5">
          ...
          <div className="bg-white rounded-3xl border border-gray-200 p-6 flex justify-between items-start shadow-sm">
            <div>
              ...
              <h1 className="text-4xl font-bold mt-4 text-black">1.250</h1>
          ...
          <div className="bg-white rounded-3xl border border-gray-200 p-6 flex justify-between items-start shadow-sm">
            <div>
              ...
              <h1 className="text-4xl font-bold mt-4 text-black">25,4 Kg</h1>
          ...
          <div className="bg-white rounded-3xl border border-gray-200 p-6 flex justify-between items-start shadow-sm">
            <div>
              ...
              <h1 className="text-4xl font-bold mt-4 text-black">12</h1>
